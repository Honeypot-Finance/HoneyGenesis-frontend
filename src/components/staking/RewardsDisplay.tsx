  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '1rem' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#ffcd4d', margin: 0 }}>
      ...
      <div>
        {!isCorrectNetwork ? (
          <div>
            <p style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#FF494A', margin: '0.5rem 0' }}>
              Switch to Berachain Testnet
            </p>
            <p style={{ fontSize: '0.9rem', color: '#999999', margin: '0 0 1rem 0' }}>
              Staking is only available on Berachain Testnet (Chain ID: {BERACHAIN_TESTNET})
            </p>
            <GeneralButton
          ...
          <div>
            <p style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'white', margin: '0.5rem 0' }}>
              {formatTokenAmount(balance, decimals, 6)} {symbol || 'REWARD'}
            </p>
            <p style={{ fontSize: '0.9rem', color: '#999999', margin: 0 }}>{name || 'Rewards Token'}</p>
          </div>
        ) : (
          <div>
